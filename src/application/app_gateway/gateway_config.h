...
#define GATEWAY_SENSOR_INTERVAL        60000   // Gateway sensor reading interval: 60 seconds
#define GATEWAY_STATUS_INTERVAL        60000   // Gateway status upload interval: 60 seconds
