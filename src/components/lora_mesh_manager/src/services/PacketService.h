...
#include "../network/entities/packets/DataPacket.h"
#include "../network/entities/packets/AppPacket.h"
#include "../network/entities/packets/RoutePacket.h"
...
public:
    ...
    /**
     * @brief Given a type returns if is a secure packet
     *
     * @param type type of the packet
     * @return true True if needed
     * @return false If not
     */
    static bool isSecurePacket(uint8_t type);
